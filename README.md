...
- `DailyLoopRunner.user.js`: `0.2.43`
...
- `84x10 MVP (1 run)`
  ...
  - 若 FSU 补全后没有把 TOTW 放进阵容，会自动把可用 TOTW 注入当前 squad，再保存并重新检查。
